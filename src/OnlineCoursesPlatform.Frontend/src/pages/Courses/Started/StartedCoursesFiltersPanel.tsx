...
interface StartedCoursesFiltersPanelProps {
  onSortChange: (sort: string) => void;
  onTagChange: (tag: string | null) => void;
  onSearch: (query: string) => void;
}

const StartedCoursesFiltersPanel: React.FC<StartedCoursesFiltersPanelProps> = ({
  onSortChange,
  onTagChange,
  onSearch,
}) => {
...
export default StartedCoursesFiltersPanel;
