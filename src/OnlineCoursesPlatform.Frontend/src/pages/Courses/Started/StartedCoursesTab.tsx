...
import { getUserEnrolledCourses } from "../../../services/accountService";
      ...
      <Box sx={{ flexGrow: 1, mt: 1 }}>
        {isLoading && page === 1 ? (
          ...
          >
            ...
            <Typography variant="body2">Follow your first course</Typography>
          </Box>
        ) : (
          <InfiniteScroll
                ...
                return (
                  <Grid key={course.id} size={size}>
                    <BasicCard
                      ...
                      isNew={isNew(course.dateCreated)}
                      isPro={false}
                      avatars={
